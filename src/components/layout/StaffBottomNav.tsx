        ...
        {navItems.map(({ path, icon: Icon, label }) => {
          ...
          return (
            <NavLink
              ...
              to={path}
              className={cn(
                "flex flex-col items-center justify-center gap-0.5 px-2 py-2 rounded-xl transition-all duration-200 min-w-0",
                isActive
                  ? "text-primary"
            ...
            >
              ...
              />
              <span className={cn(
                "text-[10px] font-medium transition-opacity truncate max-w-full",
